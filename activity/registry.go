...
func AddtoActivities(ref string, activity Activity) {
	activities[ref] = activity
}

func GetActivities() map[string]Activity {
	return activities
}

func GetActivityLoggers() map[string]log.Logger {
	return activityLoggers
}

func AddtoActivityLoggers(ref string, logger log.Logger) {
	activityLoggers[ref] = logger
}
